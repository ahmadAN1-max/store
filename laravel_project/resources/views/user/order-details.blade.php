...
@section('content')
    <style>
        .btn-back {
            ...
            box-shadow: 0 4px 6px rgba(106, 110, 81, 0.3);
        }

        .btn-back:hover {
            background-color: #b9a16b;
            color: #222;
            box-shadow: 0 6px 8px rgba(185, 161, 107, 0.5);
        }
                ...
                <div class="col-lg-10">
                    ...
                    <div class="wg-box mt-5 mb-5">
                        <div class="header-flex">
                            ...
                            <a href="{{ route('user.account.orders') }}" class="btn-back">Back</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($orderItems as $orderitem)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ optional($orderitem->product->category)->name ?? 'N/A' }}</td>
