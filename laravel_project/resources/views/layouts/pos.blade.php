...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Dashboard') - POS Dashboard </title>
        ...
        <div id="page" class="">
            <div class="layout-wrap">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('pos.index') }}" id="site-logo-inner">
                            <img id="logo_header_mobile" alt="Logo" src="{{ asset('images/logo/logo.png') }}"
                    ...
                    <div class="center">
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('pos.return') }}" class="">
                                        <div class="icon"><i class="icon-repeat"></i></div>
                            ...
                            <ul class="menu-list">
                                ...
                                @if ($admin)
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('pos.product-add') }}" class="">
                                            ...
                                            {{-- <li class="sub-menu-item">
                                                <a href="{{ route('pos.import') }}" class="">
                                                    <div class="text">Import by Excel</div>
                                                </a>
                                            </li> --}}
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('pos.brand-add') }}" class="">
                                                    <div class="text">New Brand</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('pos.brands') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('pos.category-add') }}" class="">
                                                    <div class="text">New Category</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('pos.categories') }}" class="">
