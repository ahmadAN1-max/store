                    ...
                    @enderror
                     <fieldset class="main">
                            <div class="body-title">
                                Main Category <span class="tf-color-1">*</span>
                            </div>
                            <input type="checkbox" name="main" value="1" {{ old('main', $category->main) ? 'checked' : '' }} tabindex="0">
                        ...
                        <fieldset class="freeDelivery">
                            <div class="body-title">
                                Free Delivery <span class="tf-color-1">*</span>
                            </div>
                            <input type="checkbox" name="freeDelivery" value="1" {{ old('freeDelivery', $category->free_delivery) ? 'checked' : '' }} tabindex="0">
