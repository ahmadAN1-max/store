                    ...
                    <div class="flex items-center justify-between gap10 flex-wrap">
                        <div class="wg-filter flex-grow">
                            <form class="form-search">
                                <fieldset class="name">
                                    <input type="text" id="searchInput" placeholder="Search by Reference..." class="form-control mb-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="list-icon-function">
                                                        <div class="list-icon-function">
                                                         <a href="{{ route('pos.bill.print', $bill->id) }}" target="_blank" class="btn btn-primary">Print Bill</a>
